...
class Cell:
    ...
    def make_order(self, number):
        raw = [(r'*\n' if i % number == 0 and i != self.quantity else '*') for i in range(1, self.quantity + 1)]
        return ''.join(raw)
...
print((cell_1 + cell_2).quantity)    # 71
print((cell_1 - cell_2).quantity)    # 29
print((cell_2 - cell_1).quantity)    # Маловато будет!\n 21
print((cell_1 / cell_2).quantity)    # 2
print((cell_1 * cell_2).quantity)    # 1050
